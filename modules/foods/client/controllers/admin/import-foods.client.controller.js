(function () {
  ...
  angular
    .module('foods.admin')
    .controller('FoodImportController', FoodImportController);

  FoodImportController.$inject = ['$scope', '$state', 'FileUploader', 'ngDialog'];

  function FoodImportController($scope, FileUploader) {
    var vm = this;
    vm.isSelected = false;
    prepareUploader();
    ...
    function prepareUploader() {
      ...
      vm.uploader.onSuccessItem = function (fileItem, response, status, headers) {
        ...
        if (response.status && response.result) {
          ...
          $scope.handleShowToast('食べ物インポートが完了しました');
        } else {
