(function () {
  ...
  OperatorListController.$inject = ['$scope', 'AdminService', 'UsersApi', '$window', '$location'];

  function OperatorListController($scope, AdminService, UsersApi, $window, $location) {
    var vm = this;
    onCreate();
    ...
    function prepareCondition(clear) {
      vm.condition = $scope.prepareCondition('operator', clear);
      vm.condition.roles = 'operator';
    }
    ...
    function handleSearch() {
      ...
      UsersApi.list(vm.condition)
        .success(function (res) {
          ...
          $scope.conditionFactoryUpdate('operator', vm.condition);
        })
        .error(function (err) {
          $scope.handleCloseWaiting();
