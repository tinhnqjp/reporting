(function () {
  ...
  angular
    .module('units.admin')
    .controller('PetitionListController', PetitionListController);

  PetitionListController.$inject = ['$scope', 'PetitionService', 'PetitionApi', 'WorkerApi'];

  function PetitionListController($scope, PetitionService, PetitionApi, WorkerApi) {
    var vm = this;
    onCreate();
