...
var ReportSchema = new Schema({
  ...
  // CMS
  // 備考
  note: { type: String, default: '' }, // Tất cả các loại report
  // 写真報告書有無
  has_picture_report: { type: Boolean, default: false }, // Chỉ có 洗浄
  // 情報収集シート有無
  has_info_collection: { type: Boolean, default: false }, // Chỉ có 洗浄
  // 充填回収業者名
  filler_name: { type: String, default: '' }, // Chỉ có 設置 và 修理
  // 回収ボンベ => (自社 or 他社)
  collection_bonbe: { type: Boolean, default: false }, // Chỉ có 設置 và 修理
  ...
  free: {
    // 作業内容
    work_kind: { type: String }, // Đây là field title trong Master data free_work_kind
    // 報告内容
    work_content: { type: String }, // Multiple lines
    // 指摘事項
    description: { type: String } // Multiple lines
